...
html_theme_options = {
    ...
    "github_repo": "invenio-audit-logs",
    "github_button": False,
    "github_banner": True,
...
htmlhelp_basename = "invenio-audit-logs_namedoc"
...
latex_documents = [
    (
        master_doc,
        "invenio-audit-logs.tex",
        "invenio-audit-logs Documentation",
        "CERN",
        "manual",
    ),
]
